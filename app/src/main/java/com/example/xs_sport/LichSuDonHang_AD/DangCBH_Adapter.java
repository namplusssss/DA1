...
public class DangCBH_Adapter extends RecyclerView.Adapter<DangCBH_Adapter.ViewHolder> {
    ...
    private HoaDon_Dao hoaDonDao_dao;
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, @SuppressLint("RecyclerView") int position) {
        ...
        hoaDonDao_dao = new HoaDon_Dao(context);
        ...
        holder.status.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                inv.setTrangthai_hoadon("Đã Thanh Toán");
                hoaDonDao_dao.update(inv);
                list = hoaDonDao_dao.SelectDangChuanBi();
                setData(list);
