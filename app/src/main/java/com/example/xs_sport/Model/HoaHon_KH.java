...
public class HoaHon_KH {
    ...
    public HoaHon_KH(int ma_hoadon, int ma_giohang, int sdt_hoadon, String name, String diachi_hoadon, String thoigian_hoadon, String noidung_hoadon, String trangthai_hoadon, double tong_hoadon) {
